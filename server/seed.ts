...
async function main() {
  ...
  const kumawoodSeries: MockSeries[] = [
    { id: 'kuma1', title: 'Asante Kingdom', posterUrl: 'https://res.cloudinary.com/demo/image/upload/v1/samples/placeholder_portrait_17.jpg', videoUrl: 'https://res.cloudinary.com/demo/video/upload/v1/samples/placeholder_video.mp4', episodeCount: 65, genre: 'Historical', rating: 4.7, description: 'Tales from the great Asante Empire', year: 2024, tags: ['Historical', 'Cultural', 'Drama'] },
    { id: 'kuma2', title: 'Kumasi Love', posterUrl: 'https://res.cloudinary.com/demo/image/upload/v1/samples/placeholder_portrait_18.jpg', videoUrl: 'https://res.cloudinary.com/demo/video/upload/v1/samples/placeholder_video.mp4', episodeCount: 72, genre: 'Romance', rating: 4.6, description: 'Romance blooms in Kumasi', year: 2024, tags: ['Romance', 'Comedy', 'Cultural'] },
    { id: 'kuma3', title: 'The Akan Warrior', posterUrl: 'https://res.cloudinary.com/demo/image/upload/v1/samples/placeholder_portrait_19.jpg', videoUrl: 'https://res.cloudinary.com/demo/video/upload/v1/samples/placeholder_video.mp4', episodeCount: 58, genre: 'Action', rating: 4.5, description: 'Epic battles and heroic deeds', year: 2024, tags: ['Action', 'Historical', 'Adventure'] },
    { id: 'kuma4', title: 'Village Comedy', posterUrl: 'https://res.cloudinary.com/demo/image/upload/v1/samples/placeholder_portrait_20.jpg', videoUrl: 'https://res.cloudinary.com/demo/video/upload/v1/samples/placeholder_video.mp4', episodeCount: 81, genre: 'Comedy', rating: 4.8, description: 'Hilarious village antics', year: 2024, tags: ['Comedy', 'Cultural'] },
    { id: 'kuma5', title: 'Traditional Healer', posterUrl: 'https://res.cloudinary.com/demo/image/upload/v1/samples/placeholder_portrait_21.jpg', videoUrl: 'https://res.cloudinary.com/demo/video/upload/v1/samples/placeholder_video.mp4', episodeCount: 47, genre: 'Drama', rating: 4.4, description: 'Ancient medicine meets modern skepticism', year: 2024, tags: ['Drama', 'Cultural', 'Spiritual'] },
    { id: 'kuma6', title: 'Market Queen', posterUrl: 'https://res.cloudinary.com/demo/image/upload/v1/samples/placeholder_portrait_22.jpg', videoUrl: 'https://res.cloudinary.com/demo/video/upload/v1/samples/placeholder_video.mp4', episodeCount: 69, genre: 'Drama', rating: 4.6, description: 'Power and rivalry in the marketplace', year: 2024, tags: ['Drama', 'Business'] },
  ];
